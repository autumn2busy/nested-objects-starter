...
> **Superseded for current status on 2026-09-03.** Preserve this file as dated implementation history. The only current program plan, status ledger, decision record, and handoff is the [canonical execution ledger](issue-318-foundation-execution-ledger.md).
