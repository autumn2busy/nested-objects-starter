...
export interface Testimonial {
  ...
  location?: string
  rating: number // 1-5
  source: 'google' | 'review' | 'email' | 'chat' | 'youtube'
...
export const TESTIMONIALS: Testimonial[] = [
  // ── Google Business Reviews (all 5-star) ───────────────────────
  {
    id: 'jonathan-review',
    name: 'Jonathan Kinard',
    quote:
      'I was on the fence about purchasing another list, so I listened to all Autumns youtube videos first. With a little work, I got almost instant results. Do yourself a favor and get off the fence',
    role: 'Inspector',
    rating: 5,
    source: 'google',
    date: '2026-02-23',
  ...
  },
  {
    ...
    quote:
      'If you want to get into the field of property inspections and becoming an inspector, the folks over at Nested Objects are your best bet. They are well connected and have streamlined the process.',
  ...
  },
  {
    ...
    name: 'Alex P. Louis',
    quote:
      'I was very skeptical about the information and the resources available prior to purchasing membership access to the site. I must say that I have been very impressed. There are hundreds of companies with up to date contact information... I highly recommend Nested Objects.',
    role: 'New Inspector',
    rating: 5,
    source: 'google',
    date: '2025-10-21',
  ...
  },
  {
    ...
    name: 'Raquel M. W.',
    quote:
      'The webinar provided a wealth of good information and was extremely informative about the role of Field Inspectors.',
    rating: 5,
    source: 'google',
    date: '2025-05-30',
    featured: false,
  ...
  {
    id: 'mike-review',
    name: 'Michael "Mike" Williams',
    quote:
      'Excellent resource for finding field inspection jobs/gigs (commercial, property, auto, etc.). Also a great resource for market research.',
