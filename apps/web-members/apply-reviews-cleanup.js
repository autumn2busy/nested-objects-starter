...
const summaries = {
    ...
    'lowry-associates': 'While some team members enjoy the collaborative culture and time flexibility, others criticize the low pay, high turnover in operations, and instances of poor management behavior.'
};
...
console.log(`Updated ${updated} remaining firms in cleanup with real reviews.`);
