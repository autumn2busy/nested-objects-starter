        ...
        <div className="flex min-h-screen bg-slate-50 font-sans">
            ...
            <aside className={cn(
                ...
                <div className="p-6 border-b border-slate-100">
                    <Link href={`/challenges/basic/${moduleId}`} className="text-sm text-slate-500 hover:text-blue-600 flex items-center gap-2 mb-4">
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-2">
                    {moduleData.lessons?.map((lesson, idx) => {
                        ...
                        return (
                            <Link
                                key={lesson.id}
                                href={`/challenges/basic/${moduleId}/lesson/${lesson.id}`}
                                className={cn(
            ...
            <main className="flex-1 max-w-4xl mx-auto w-full p-4 lg:p-12 pb-32">
                ...
                <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 p-4 lg:pl-80 z-30">
                    <div className="max-w-4xl mx-auto flex items-center justify-between gap-4">
                        {prevLesson ? (
                            <Link
                                href={`/challenges/basic/${moduleId}/lesson/${prevLesson.id}`}
