...
export default function ModuleOverviewPage() {
    ...
    if (error || !module) return <div className="min-h-screen bg-slate-50 flex items-center justify-center"><div className="text-center"><AlertTriangle className="w-12 h-12 text-red-500 mx-auto mb-4" /><p>{error}</p><Link href="/challenges" className="text-emerald-600 hover:underline">← Back</Link></div></div>

    // Render Sidebar
    const Sidebar = () => (
        <aside className="w-72 bg-white border-r border-slate-200 flex-shrink-0 overflow-y-auto hidden lg:block">
            <div className="p-4 border-b border-slate-100">
                <Link href="/challenges" className="text-xs text-slate-500 hover:text-slate-700 flex items-center gap-1 mb-2"><ChevronLeft className="w-3 h-3" />BACK TO CURRICULUM</Link>
                <div className="flex items-center gap-3">
