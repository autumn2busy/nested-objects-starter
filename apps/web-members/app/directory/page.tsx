...
export default function DirectoryPage() {
  ...
  // Full filtered set (used for Pro+ and fallback)
  const filteredFirms = firms.filter(matchesStateFilter).filter(matchesSearch)

  // Starter featured list: fixed 5, ordered by starter_rank
  const starterFeaturedFirms = firms
    .filter((firm) => !!firm.starter_featured)
    .sort((a, b) => {
      const ra = a.starter_rank ?? 999
      const rb = b.starter_rank ?? 999
  ...
  if (isStarter) {
    // For Starter, ignore filters and always show the same curated 5
    const source = starterFeaturedFirms.length ? starterFeaturedFirms : filteredFirms
    displayedFirms = source.slice(0, 5)
  } else {
    displayedFirms = filteredFirms
  }
          ...
          <>
            ...
            >
              <div style={{ flex: '0 0 220px' }}>
                ...
                >
                  {isStarter
                    ? 'Filter by service area (locked on Starter)'
                ...
                <select
                  ...
                  style={{
                    ...
                    fontSize: '0.9rem',
                    backgroundColor: isStarter ? '#f9fafb' : 'white',
                    color: isStarter ? '#9ca3af' : '#111827',
              ...
              <div style={{ flex: '1 1 300px' }}>
                ...
                >
                  {isStarter
                    ? 'Search by name or keyword (upgrade to unlock)'
                ...
                <input
                  ...
                  placeholder={
                    isStarter
                      ? 'Keyword search is part of Pro and Elite plans.'
              ...
              <div style={{ display: 'flex', alignItems: 'flex-end' }}>
                ...
                >
                  {isStarter
                    ? 'You are seeing a curated sample of firms. Upgrade to search and filter the full directory.'
                    : 'Tip: many firms are national or multi-state, so start broad then narrow down.'}
                </p>
              </div>
            </section>
            ...
            {isStarter && (
              ...
              >
                ...
                >
                  Starter members see a fixed preview
                </h3>
                <p
                  style={{
                    fontSize: '0.9rem',
                ...
                >
                  These five firms are a curated sample so you can get a feel for the
                  directory. Pro and Elite unlock full search, filters, and every
                  hiring firm we add.
                </p>
                <Link
                  href="/membership"
            ...
            >
              ...
              >
                ...
                >
                  Pins show firms in your current preview. Hover over pins to see
                  details. Zoom and pan to explore.
                </p>
            ...
            {isStarter && displayedFirms.length > 0 && (
              <p
                style={{
                  marginTop: '1.5rem',
                  fontSize: '0.85rem',
              ...
              >
                You are seeing a fixed set of {displayedFirms.length} featured firms on
                the Starter preview. Upgrade any time to unlock the full directory.
              </p>
            )}
