...
export default async function DirectoryPage({ searchParams }: DirectoryPageProps) {
  ...
  const effectivePage = isStarter ? DEFAULT_PAGE : page
  const effectiveLimit = isStarter ? PREVIEW_LIMIT : limit
  const { firms, totalCount } = await getFirms(effectivePage, effectiveLimit)
