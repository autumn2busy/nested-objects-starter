      ...
      <Gate feature="firm_intel">
        <section>
          <p style={{ marginBottom: '1rem' }}>
            This is where you will eventually show deep dives for firms like Safeguard, MCS, MSI,
            Xome, and others. Think pay band summaries, expectations, and tips to stay on their
            preferred lists.
          </p>
          <ul style={{ listStyle: 'disc', paddingLeft: '1.25rem', fontSize: '0.95rem' }}>
            ...
            <li>Tie each intel card back to firms in your directory for quick navigation.</li>
          </ul>
        </section>
      </Gate>
    </main>
