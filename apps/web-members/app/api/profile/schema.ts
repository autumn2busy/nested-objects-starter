...
export function buildFallbackProfileSchemaInfo(): ProfileSchemaInfo {
    // IMPORTANT: When the probe fails, we fall back to ONLY the guaranteed columns.
    // Previously this assumed ALL optional columns existed, which caused the 42703 error
    // when is_published (or any other optional column) was missing from the actual table.
    return {
