                ...
                <section className="space-y-8">
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                            ...
                            <Link href="/challenges/modules/safety" className="text-sm font-semibold text-brand-copper hover:underline">
                                Start safety module →
                            </Link>
                        </div>
                        ...
                        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                            ...
                            <Link href="/challenges/modules/logistics" className="text-sm font-semibold text-brand-copper hover:underline">
                                Watch walkthroughs →
                            </Link>
                        </div>
                        ...
                        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                            ...
                            <Link href="/challenges/modules/photography" className="text-sm font-semibold text-brand-copper hover:underline">
                                View gallery →
                            </Link>
                        </div>
                    </div>
