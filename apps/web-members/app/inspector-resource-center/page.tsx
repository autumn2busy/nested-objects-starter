...
export const metadata: Metadata = generatePageMetadata({
  ...
  path: '/inspector-resource-center',
})
...
const resourceHighlights = [
  ...
  },
  {
    ...
    cta: { label: 'Open readiness guides', href: '/inspector-resource-center/readiness-guides' },
  },
  {
    ...
    cta: { label: 'View firm intel', href: '/inspector-resource-center/firm-intel' },
  },
  {
