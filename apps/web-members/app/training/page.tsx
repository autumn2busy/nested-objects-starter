...
// Training data and avatarResponses are exactly as you provided
// [keeping your full trainingData and avatarResponses here unchanged]

const trainingData: Record<Role, Record<ExperienceLevel, LearningModule[]>> = {
  // ... paste your full trainingData object here unchanged ...
}
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-2">
                {currentModules.map(module => (
                  ...
                  >
                    <span className="mr-2">
                      {moduleProgress[module.id] ? <CheckCircleIcon /> : <CircleIcon />}
                    </span>
