...
export const FEATURE_ACCESS: Record<string, string[]> = {
  ...
  client_workspace: [PLAN_UIDS.STARTER, PLAN_UIDS.PRO, PLAN_UIDS.ELITE, PLAN_UIDS.AGENCY, PLAN_UIDS.FOUNDERS],
  company_tracker: [PLAN_UIDS.STARTER, PLAN_UIDS.PRO, PLAN_UIDS.ELITE, PLAN_UIDS.AGENCY, PLAN_UIDS.FOUNDERS],
