...
export const membershipPlans: MembershipPlan[] = [
  {
    ...
    features: [
      ...
      'Client, company, AI resume, AI concierge, and job tracking tools',
  ...
  },
  {
    ...
    features: [
      ...
      'Client, company, AI concierge, AI resume, and job tracking tools',
      'Resources, templates, and guides',
      'Standard support',
  ...
  },
  {
    ...
    price: '$49',
    period: 'month',
    headline: 'Full firm intel. Core member tools.',
    description:
    ...
    features: [
      ...
      'Income scenario planner using your own assumptions',
      'AI Concierge and AI Resume Builder',
      'Client, company, and job tracking tools',
  ...
  },
  {
    ...
    features: [
      'Everything in Elite',
      'Every current member tool for existing Agency members',
