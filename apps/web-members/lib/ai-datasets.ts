...
export const membershipPlans: MembershipPlan[] = [
  ...
  },
  {
    ...
    description:
      'The working field-inspector membership: full directory, training library, readiness resources, and weekly insights. Member tools remain preview-only until separately enabled.',
    highlight: true,
    features: [
      ...
      'Preview planned job, route, income, and weather tools',
  ...
  },
  {
    ...
    features: [
      ...
      'White label options',
      'Enterprise API evaluation path',
      'Team onboarding and admin roadmap review',
